...
#folder_TDA = r"C:\@data\ETF\i=7_TDA_L=52x8B\TDA"
#folder_TDA = r"C:\@data\ETF\i=6_TDA_L=52x8A\TDA"
#folder_TDA = r"C:\@data\ETF\i=5_TDA_L=260\TDA"
#folder_TDA = r"C:\@data\ETF\i=4_TDA_full_PL_rebase100\TDA"
...
### set output paths
#f_out = r"C:\@data\ETF"
#f_out = r"C:\@data\ETF\TDA\@tmp"
#f_out = r"C:\@data\ETF\i=2_TDA=norms@batch"
#f_out = r"C:\@data\ETF\i=3_y@4w"
#f_out = r"C:\@data\ETF\i=4_TDA_full_PL_rebase100"
#f_out = r"C:\@data\ETF\i=5_TDA_L=260"
#f_out = r"C:\@data\ETF\i=6_TDA_L=52x8A"
#f_out = r"C:\@data\ETF\i=7_TDA_L=52x8B"
#f_out = r"C:\@data\ETF\i=8_TDA_L=52x8C"
...
#X_tr.to_csv(f_X_tr,index=False,header=False)
#y_tr.to_csv(f_y_tr,index=False,header=False)
#X_te.to_csv(f_X_te,index=False,header=False)
#y_te.to_csv(f_y_te,index=False,header=False)
#X_va.to_csv(f_X_va,index=False,header=False)
#y_va.to_csv(f_y_tr,index=False,header=False)
