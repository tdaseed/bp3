...
modelTrainer <- function(X,Y, nrounds){
  params <- list(booster = "gbtree", objective = "binary:logistic", max_depth = 5, 
...
#f_out <- "N:/Risk_and_Performance/Public/Analytics/Risk@Weekly/Backtest/output_5_xTDA_HSI_FF.csv"
f_out <- "N:/Risk_and_Performance/Public/Analytics/Risk@Weekly/Backtest/output_5_wTDA_HSI_NEW3.csv"
